...
async def seed_data():
    ...
    async with async_session() as db:
        ...
        dir_cyber = Direction(
            ...
            icon="🎮",
            color="#6C5CE7",
            cover_image_url="/images/directions/cybersport.jpg",
        ...
        dir_laser = Direction(
            ...
            icon="🔫",
            color="#FF6B6B",
            cover_image_url="/images/directions/lasertag.jpg",
        ...
        dir_drones = Direction(
            ...
            icon="🛸",
            color="#00D2D3",
            cover_image_url="/images/directions/drones.jpg",
        ...
        dir_ps = Direction(
            ...
            icon="🕹️",
            color="#FECA57",
            cover_image_url="/images/directions/playstation.jpg",
        ...
        dir_pc = Direction(
            ...
            icon="💻",
            color="#00B894",
            cover_image_url="/images/directions/computers.jpg",
            default_slot_capacity=10,
            slot_durations=[60, 120],
            sort_order=5,
        )
        ...
        rewards = [
            Reward(name="Фирменная футболка CIFRA", description="Чёрная футболка с логотипом CIFRA на груди и принтом на спине. Размеры: S, M, L, XL. Хлопок 100%.", cost_points=200, stock=20, is_active=True, photo_url="/images/rewards/tshirt.jpg"),
            Reward(name="Стикерпак CIFRA", description="Набор из 10 фирменных стикеров с персонажами и мемами CIFRA.", cost_points=50, stock=50, is_active=True, photo_url="/images/rewards/stickers.jpg"),
            Reward(name="Powerbank 10000 mAh", description="Портативная зарядка Xiaomi с гравировкой логотипа CIFRA.", cost_points=500, stock=5, is_active=True, photo_url="/images/rewards/powerbank.jpg"),
            Reward(name="Игровой коврик для мыши XL", description="Коврик 800x300 мм с символикой CIFRA. Ткань + резиновая основа.", cost_points=150, stock=15, is_active=True, photo_url="/images/rewards/mousepad.jpg"),
            Reward(name="Кружка CIFRA", description="Керамическая кружка 350 мл с логотипом. Можно в посудомойку.", cost_points=100, stock=30, is_active=True, photo_url="/images/rewards/mug.jpg"),
            Reward(name="Худи CIFRA (лимитка)", description="Худи оверсайз с вышивкой CIFRA. Лимитированная серия, чёрный цвет.", cost_points=800, stock=3, is_active=True, photo_url="/images/rewards/hoodie.jpg"),
            Reward(name="Ланъярд с карабином", description="Шнурок для бейджа/ключей с логотипом CIFRA.", cost_points=30, stock=100, is_active=True, photo_url="/images/rewards/lanyard.jpg"),
        ]
        for r in rewards:
            db.add(r)
        ...
        news = [
            NewsPost(
                ...
                slug="cifra-launched",
                type="news",
                cover_image_url="/images/news/cifra-launch.jpg",
            ...
            NewsPost(
                ...
                cover_image_url="/images/news/cs2-cup.jpg",
            ...
            NewsPost(
                ...
                cover_image_url="/images/news/fpv-goggles.jpg",
            ...
            NewsPost(
                ...
                cover_image_url="/images/news/fifa25.jpg",
            ...
            NewsPost(
                ...
                type="announcement",
                cover_image_url="/images/news/holiday.jpg",
            ...
            NewsPost(
                ...
                type="announcement",
                direction_id=dir_cyber.id,
                cover_image_url="/images/news/dota2.jpg",
            ...
            NewsPost(
                ...
                slug="vr-day-event",
                type="news",
                cover_image_url="/images/news/vr-day.jpg",
            ...
            NewsPost(
                ...
                type="announcement",
                direction_id=dir_cyber.id,
                cover_image_url="/images/news/cs2-league.jpg",
            ...
            NewsPost(
                ...
                type="announcement",
                direction_id=dir_drones.id,
                cover_image_url="/images/news/drone-day.jpg",
            ...
            NewsPost(
                ...
                cover_image_url="/images/news/lasertag-battle.jpg",
            ...
            NewsPost(
                ...
                type="result",
                cover_image_url="/images/news/weekly-top.jpg",
            ...
            NewsPost(
                ...
                type="news",
                cover_image_url="/images/news/dksh-mentor.jpg",
