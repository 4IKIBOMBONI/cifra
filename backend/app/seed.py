...
async def seed_data():
    ...
    async with async_session() as db:
        ...
        dir_laser = Direction(
            ...
            icon="🔫",
            color="#FF6B6B",
            cover_image_url="https://images.unsplash.com/photo-1626379616459-b2ce0c753810?w=800&q=80",
        ...
        dir_drones = Direction(
            ...
            icon="🛸",
            color="#00D2D3",
            cover_image_url="https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=800&q=80",
        ...
        dir_pc = Direction(
            ...
            icon="💻",
            color="#00B894",
            cover_image_url="https://images.unsplash.com/photo-1593062096033-9a26b09da705?w=800&q=80",
            default_slot_capacity=10,
            slot_durations=[60, 120],
            sort_order=5,
        )
        ...
        rewards = [
            Reward(name="Фирменная футболка CIFRA", description="Чёрная футболка с логотипом CIFRA на груди и принтом на спине. Размеры: S, M, L, XL. Хлопок 100%.", cost_points=200, stock=20, is_active=True, photo_url="https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&q=80"),
            Reward(name="Стикерпак CIFRA", description="Набор из 10 фирменных стикеров с персонажами и мемами CIFRA.", cost_points=50, stock=50, is_active=True, photo_url="https://images.unsplash.com/photo-1572375992501-4b0892d50c69?w=400&q=80"),
            Reward(name="Powerbank 10000 mAh", description="Портативная зарядка Xiaomi с гравировкой логотипа CIFRA.", cost_points=500, stock=5, is_active=True, photo_url="https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400&q=80"),
            Reward(name="Игровой коврик для мыши XL", description="Коврик 800x300 мм с символикой CIFRA. Ткань + резиновая основа.", cost_points=150, stock=15, is_active=True, photo_url="https://images.unsplash.com/photo-1527814050087-3793815479db?w=400&q=80"),
            Reward(name="Кружка CIFRA", description="Керамическая кружка 350 мл с логотипом. Можно в посудомойку.", cost_points=100, stock=30, is_active=True, photo_url="https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=400&q=80"),
            Reward(name="Худи CIFRA (лимитка)", description="Худи оверсайз с вышивкой CIFRA. Лимитированная серия, чёрный цвет.", cost_points=800, stock=3, is_active=True, photo_url="https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=400&q=80"),
            Reward(name="Ланъярд с карабином", description="Шнурок для бейджа/ключей с логотипом CIFRA.", cost_points=30, stock=100, is_active=True, photo_url="https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&q=80"),
        ]
        for r in rewards:
            db.add(r)
        ...
        news = [
            NewsPost(
                ...
                slug="cifra-launched",
                type="news",
                cover_image_url="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=800&q=80",
            ...
            NewsPost(
                ...
                cover_image_url="https://images.unsplash.com/photo-1542751110-97427bbecf20?w=800&q=80",
            ...
            NewsPost(
                ...
                cover_image_url="https://images.unsplash.com/photo-1579829366248-204fe8413f31?w=800&q=80",
            ...
            NewsPost(
                ...
                type="announcement",
                cover_image_url="https://images.unsplash.com/photo-1513151233558-d860c5398176?w=800&q=80",
            ...
            NewsPost(
                ...
                slug="vr-day-event",
                type="news",
                cover_image_url="https://images.unsplash.com/photo-1622979135225-d2ba269cf1ac?w=800&q=80",
            ...
            NewsPost(
                ...
                type="announcement",
                direction_id=dir_drones.id,
                cover_image_url="https://images.unsplash.com/photo-1508614589041-895b88991e3e?w=800&q=80",
            ...
            NewsPost(
                ...
                cover_image_url="https://images.unsplash.com/photo-1547394765-185e1e68f34e?w=800&q=80",
            ...
            NewsPost(
                ...
                type="result",
                cover_image_url="https://images.unsplash.com/photo-1552820728-8b83bb6b2b28?w=800&q=80",
